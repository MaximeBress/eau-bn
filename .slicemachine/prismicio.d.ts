...
interface AchievementDocumentData {
    /**
     * meta_title field in *Réalisation*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
    ...
    /**
     * meta_description field in *Réalisation*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
    ...
    /**
     * Image field in *Réalisation*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: achievement.image
     * - **Tab**: Main
     ...
     *
     */
    slices: prismicT.SliceZone<AchievementDocumentDataSlicesSlice>;
}
/**
 * Slice for *Réalisation → Slice Zone*
 *
 */
type AchievementDocumentDataSlicesSlice = HeroSlice | ImageSlice | ImageCardsSlice | TextWithImageSlice | TextSlice | QuoteSlice;
/**
 ...
 */
export type AchievementDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<Simplify<AchievementDocumentData>, "achievement", Lang>;
